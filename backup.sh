...
clear
echo " VPS Data Backup By SmartTunnelScript"
sleep 1
...
clear
echo -e "\033[1;37mVPS Data Backup By SmartTunnelScript\033[0m
\033[1;37mTelegram : https://t.me/smarttunnel / @SmartTunnel\033[0m"
echo ""
