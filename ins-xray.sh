...
# // Exporting URL Host
export Server_URL="raw.githubusercontent.com/SmartXHacker/SmartTunnelScript/main/test"
export Server1_URL="raw.githubusercontent.com/SmartXHacker/SmartTunnelScript/main/limit"
...
wget -q -O /etc/nginx/nginx.conf "https://raw.githubusercontent.com/SmartXHacker/SmartTunnelScript/main/nginx.conf" 
#mkdir -p /home/vps/public_html
wget -q -O /etc/nginx/conf.d/vps.conf "https://raw.githubusercontent.com/SmartXHacker/SmartTunnelScript/main/vps.conf"
